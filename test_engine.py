...
def test_collision():
    ...
    print(f"  Sphere-sphere: depth={contact.depth:.4f}")
    ...
    print(f"  Ground collision: depth={ground_contact.depth:.4f}")
...
def test_solver():
    ...
    print(f"  Bounce: final_y={ball.pos.y:.3f}")
...
if __name__ == "__main__":
    print("FluxSim Physics Engine - Test Suite\n")
