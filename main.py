...
def sphere_wireframe(center, radius, segments=12):
...
def draw_box(ax, body, half, color='blue'):
...
def run_bouncing_balls():
    print("=== FluxSim: Bouncing Balls Demo ===")
    ...
    ax.set_ylabel('Y')
    ax.set_zlabel('Z')
    ax.set_title('FluxSim - Final State (Bouncing Balls)')
...
def run_spinning_box():
    print("=== FluxSim: Spinning Box Demo ===")
    ...
    ax.set_ylabel('Y')
    ax.set_zlabel('Z')
    ax.set_title('FluxSim - Box Trajectory (Spinning Box)')
...
def run_collision_chain():
    print("=== FluxSim: Collision Chain Demo ===")
    ...
    ax.set_ylabel('Y')
    ax.set_zlabel('Z')
    ax.set_title('FluxSim - Newton Cradle Style (Collision Chain)')
...
def print_system_info():
    print("\n" + "="*50)
    print("  FluxSim - 3D Physics Engine")
    print("="*50)
    print("\nModules:")
    print("  - math_util.py : Vec3, Mat3, Quat")
    print("  - body.py      : RigidBody, RK4 Integrator")
    print("  - collision.py : GJK + EPA")
    print("  - solver.py    : Impulse Resolution")
    print("\nFeatures:")
    print("  - Quaternion rotations (no gimbal lock)")
    print("  - RK4 integration (stable)")
    print("  - 3x3 inertia tensors")
    print("  - GJK/EPA collision detection")
    print("  - Impulse-based resolution")
    print("  - Linear + angular friction")
    print("="*50 + "\n")
...
if __name__ == "__main__":
    ...
    if choice == '1':
        ...
        print("Running default demo (Bouncing Balls)...")
        run_bouncing_balls()
